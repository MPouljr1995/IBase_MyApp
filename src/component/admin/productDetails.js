                ...
                <Grid container>
                {
                    products.map(product =>(
                          <Grid item xs={12} style={{marginTop:'20px'}}  >
                                  ...
                                  <Card className='productCardPD' key={product.id}  elevation={5}>
                                    <CardActionArea >
                                      <Box className='productDetailShowImgDiv'>
                                        <CardMedia
                                          id='showImgPD1'
                                          component="img"
                                          image={product.imgName1}
                                    ...
                                    <Box style={{float:'right',marginRight:'30px', width:'250px',marginBottom:'30px'}} >
                                        <Button variant="contained" id="editBtn" style={{backgroundColor:'#03a9f4',color:'white',margin:'auto',fontWeight:'bold'}} onClick={() => this.editProduct(product.Id)} ><CreateIcon style={{marginRight:'5px'}}/>
                                        Edit
                                        </Button>
                                        <Button variant="contained" id="deleteBtn" style={{backgroundColor:'#03a9f4',color:'white',margin:'auto',fontWeight:'bold'}} onClick={() => this.deleteProduct(product.Id)} ><DeleteIcon style={{marginRight:'5px'}}/>
                                        Delete
                                        </Button>
                                    </Box>
                                  </Card>
